...
const styles: Record<string, string> = {
  Exchange: "bg-cyan-50 text-cyan-700 border border-cyan-200",
  ...
  "Summer School": "bg-sky-50 text-sky-700 border border-sky-200",
  Draft: "bg-slate-100 text-slate-600 border border-slate-200",
  Submitted: "bg-blue-50 text-blue-700 border border-blue-200",
  "Under Review": "bg-amber-50 text-amber-700 border border-amber-200",
  Approved: "bg-emerald-50 text-emerald-700 border border-emerald-200",
  Rejected: "bg-rose-50 text-rose-700 border border-rose-200",
  Nominated: "bg-violet-50 text-violet-700 border border-violet-200",
